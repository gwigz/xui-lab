...
from xui_lab.operations import LabelSelector, RoleSelector
from xui_lab.selectors import match_nodes, rank_locator, require_unique
...
class SelectorTests(unittest.TestCase):
    ...
    def test_hidden_controls_do_not_match_label_locators(self) -> None:
        ...
        self.assertEqual([], match_nodes(tree, LabelSelector("OK")))
        with self.assertRaises(AssertionFailure):
            require_unique(tree, RoleSelector("button", "OK"))
